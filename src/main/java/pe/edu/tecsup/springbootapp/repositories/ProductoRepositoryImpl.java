...
public class ProductoRepositoryImpl implements ProductoRepository {
	...
	public List<Producto> listar() throws Exception {
		...
		String sql = "SELECT p.id, p.categorias_id, c.nombre AS categorias_nombre, p.nombre, p.descripcion, p.precio, p.stock, p.imagen_nombre, p.imagen_tipo, p.imagen_tamanio, p.creado, p.estado\r\n"
	...
	public void registrar(Producto producto) throws Exception {
		...
		String sql = "INSERT INTO productos (categorias_id, nombre, descripcion, precio, stock, imagen_nombre, imagen_tipo, imagen_tamanio)\r\n"
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		jdbcTemplate.update(sql, producto.getCategorias_id(), producto.getNombre(), producto.getDescripcion(),
				producto.getPrecio(), producto.getStock(), producto.getImagen_nombre(), producto.getImagen_tipo(),
